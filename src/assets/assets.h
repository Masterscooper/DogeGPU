...
#ifndef DOGEGPU_ASSET_PROTOCOL_H
#define DOGEGPU_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_DOGPU_ASSET DOGPUSQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_DOGPU_ASSET DOGPUSO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_DOGPU_ASSET DOGPUSR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_DOGPU_ASSET DOGPUST
...
#endif //DOGEGPU_ASSET_PROTOCOL_H
