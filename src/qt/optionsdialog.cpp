    ...
    mapper(0)
{
    ...
    ui->dogpuAtStartup->setToolTip(ui->dogpuAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->dogpuAtStartup->setText(ui->dogpuAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openDogpuConfButton->setToolTip(ui->openDogpuConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new DogpuUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->dogpuAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openDogpuConfButton_clicked()
{
