...
#ifndef DOGPU_QT_GUIUTIL_H
#define DOGPU_QT_GUIUTIL_H
...
/** Utility functions used by the Dogpu Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "dogpu:" URI into recipient object, return true on successful parsing
