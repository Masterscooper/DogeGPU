...
#ifndef DOGPU_QT_DOGPUUNITS_H
#define DOGPU_QT_DOGPUUNITS_H
...
/** Dogpu unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DogpuUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DogpuUnits(QObject *parent);
...
typedef DogpuUnits::Unit DogpuUnit;

#endif // DOGPU_QT_DOGPUUNITS_H
