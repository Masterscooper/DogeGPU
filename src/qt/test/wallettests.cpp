...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<DogpuAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_dogpu-qt -platform xcb      # Linux
//     src/qt/test/test_dogpu-qt -platform windows  # Windows
//     src/qt/test/test_dogpu-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = DogpuUnits::formatWithUnit(unit, balance, false, DogpuUnits::separatorAlways);
    ...
    // Amount input
    DogpuAmountField* amountInput = receiveCoinsDialog.findChild<DogpuAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: dogpu:")) != -1);
