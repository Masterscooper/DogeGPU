...
int main(int argc, char *argv[])
{
    ...
    noui_connect();
    ClearDatadirCache();
    fs::path pathTemp = fs::temp_directory_path() / strprintf("test_dogpu-qt_%lu_%i", (unsigned long) GetTime(), (int) GetRand(100000));
    ...
    static const char* qt_argv = "Dogpu-Qt-test";

    QApplication app(qt_argc, const_cast<char **>(&qt_argv));
    app.setApplicationName("Dogpu-Qt-test");
