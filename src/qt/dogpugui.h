...
#ifndef DOGPU_QT_DOGPUGUI_H
#define DOGPU_QT_DOGPUGUI_H
...
/**
  Dogpu GUI main class. This class represents the main window of the Dogpu UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DogpuGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit DogpuGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~DogpuGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a dogpu wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
