...
#include "config/dogpu-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatDogpuURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + DogpuUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatDogpuURI(info));
}
