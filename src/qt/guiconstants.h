...
#ifndef DOGPU_QT_GUICONSTANTS_H
#define DOGPU_QT_GUICONSTANTS_H
...
/* DogpuGUI -- Size of icons in status bar */
...
// /* Dogegpu shadow color - light mode */
...
/** LIGHT MODE */
/* Background color, very light gray */
#define COLOR_BACKGROUND_LIGHT QColor("#9f7f15")
/* Dogegpu dark orange */
#define COLOR_DARK_ORANGE QColor("#34201b")
/* Dogegpu light orange */
#define COLOR_LIGHT_ORANGE QColor("#9f7f15")
/* Dogegpu dark blue */
#define COLOR_DARK_BLUE QColor("#34201a")
/* Dogegpu light blue */
#define COLOR_LIGHT_BLUE QColor("#452b23")
/* Dogegpu asset text */
#define COLOR_ASSET_TEXT QColor(255, 255, 255)
/* Dogegpu shadow color - light mode */
#define COLOR_SHADOW_LIGHT QColor("#e1e6f3")
/* Toolbar not selected text color */
#define COLOR_TOOLBAR_NOT_SELECTED_TEXT QColor("#e1b41f")
/* Toolbar selected text color */
#define COLOR_TOOLBAR_SELECTED_TEXT COLOR_WHITE
/* Send entries background color */
#define COLOR_SENDENTRIES_BACKGROUND QColor("#9f7f15")


/** DARK MODE */
/* Widget background color, dark mode */
#define COLOR_WIDGET_BACKGROUND_DARK QColor("#1c2535")
/* Dogegpu shadow color - dark mode */
#define COLOR_SHADOW_DARK QColor("#0c1b3d")
/* Dogegpu Light blue - dark mode - dark mode */
#define COLOR_LIGHT_BLUE_DARK QColor("#1e2636")
/* Dogegpu Dark blue - dark mode - dark mode */
#define COLOR_DARK_BLUE_DARK QColor("#0b1018")
/* Pricing widget background color */
#define COLOR_PRICING_WIDGET QColor("#161e2d")
/* Dogegpu dark mode administrator background color */
#define COLOR_ADMIN_CARD_DARK COLOR_BLACK
/* Dogegpu dark mode regular asset background color */
...
/* Dogegpu label color as a string */
...
#define QAPP_ORG_NAME "Dogpu"
#define QAPP_ORG_DOMAIN "dogpu.com"
#define QAPP_APP_NAME_DEFAULT "Dogpu-Qt"
#define QAPP_APP_NAME_TESTNET "Dogpu-Qt-testnet"

/* Default third party browser urls separate with | */
#define DEFAULT_THIRD_PARTY_BROWSERS "https://explorer.dogegpu.com/tx/%s"

/* Default IPFS viewer */
#define DEFAULT_IPFS_VIEWER "https://ipfs.io/ipfs/%s"

#endif // DOGPU_QT_GUICONSTANTS_H
