...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(DogpuUnits::DOGPUS),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->dogpusBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->dogpusBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(DogpuUnits::formatWithUnit(unit, balance, false, DogpuUnits::separatorAlways));
    ui->labelUnconfirmed->setText(DogpuUnits::formatWithUnit(unit, unconfirmedBalance, false, DogpuUnits::separatorAlways));
    ui->labelImmature->setText(DogpuUnits::formatWithUnit(unit, immatureBalance, false, DogpuUnits::separatorAlways));
    ui->labelTotal->setText(DogpuUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, DogpuUnits::separatorAlways));
    ui->labelWatchAvailable->setText(DogpuUnits::formatWithUnit(unit, watchOnlyBalance, false, DogpuUnits::separatorAlways));
    ui->labelWatchPending->setText(DogpuUnits::formatWithUnit(unit, watchUnconfBalance, false, DogpuUnits::separatorAlways));
    ui->labelWatchImmature->setText(DogpuUnits::formatWithUnit(unit, watchImmatureBalance, false, DogpuUnits::separatorAlways));
    ui->labelWatchTotal->setText(DogpuUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, DogpuUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("DOGPUS")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the DOGPUS balance grid from expanding and looking terrible when asset balance is hidden
