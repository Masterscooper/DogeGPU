...
#ifndef DOGPU_TEST_SCRIPTNUM10_H
#define DOGPU_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Dogpu Core 0.10.0, for cross-comparison.
 */
public:
