...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1DOGPUS 10000

// amounts 50 .. 21000000
#define NUM_MULTIPLES_50DOGPUS 420000
...
BOOST_FIXTURE_TEST_SUITE(compress_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(compress_amounts_test)
    {
        ...
        for (uint64_t i = 1; i <= NUM_MULTIPLES_1DOGPUS; i++)
            BOOST_CHECK(TestEncode(i * COIN));

        for (uint64_t i = 1; i <= NUM_MULTIPLES_50DOGPUS; i++)
