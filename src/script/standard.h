...
#ifndef DOGPU_SCRIPT_STANDARD_H
#define DOGPU_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_DOGPU_ASSET script that carries data
    /** DOGPUS END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a dogegpu address
 */
...
/**
 * Generate a Dogpu scriptPubKey for the given CTxDestination. Returns a P2PKH
