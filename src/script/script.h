...
#ifndef DOGPU_SCRIPT_SCRIPT_H
#define DOGPU_SCRIPT_SCRIPT_H
...
public:
    ...
    bool GetOp2(const_iterator& pc, opcodetype& opcodeRet, std::vector<unsigned char>* pvchRet) const
    {
        ...
        // If we see an op dogpus asset, we consider all data after it has data, and not op codes
        // Move the pc to the end of the script
        if (opcode == OP_DOGPUS_ASSET) {
    ...
    /**
     * Pre-version-0.6, Dogpu always counted CHECKMULTISIGs
