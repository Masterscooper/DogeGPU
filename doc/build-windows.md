...
Below are some notes on how to build Dogpu Core for Windows.
...
way. This will install to `c:\workspace\dogpu`, for example:

    make install DESTDIR=/mnt/c/workspace/dogpu
