...
By default, dogpu-core allows up to 125 connections to different peers, 12 of
...
limits are tiny. Keep in mind that dogpu's trustless model works best if you are
