...
This document provides guidelines for internationalization of the Dogpu Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `dogpu_en.ts` remains unchanged.
