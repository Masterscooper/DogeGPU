Dogpu Core version *2.1.0* is now available!!
==============

  <https://github.com/Masterscooper/Dogegpu/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/Masterscooper/Dogegpu/commits/release_2.1.0>
