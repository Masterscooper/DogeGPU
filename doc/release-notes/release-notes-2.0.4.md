Dogpu Core version *2.0.4.0* is now available!!
==============

  <https://github.com/Masterscooper/Dogegpu/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/Masterscooper/Dogegpu/commits/release_2.0.4>
