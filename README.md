...
anyone, anywhere in the world. The DogeGPU platform also lets anyone create assets (tokens) on the DogeGPU network. 
...
DogeGPU is a use case specific blockchain designed to carry statements of truth about who owns what assets. 
...
DogeGPU is designed to be a use case specific blockchain designed to efficiently handle one specific function: the transfer of assets from one party to another.
