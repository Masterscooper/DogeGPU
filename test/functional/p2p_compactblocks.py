...
# TestNode: A peer we use to send messages to dogpud, and store responses.
...
class CompactBlocksTest(DogpuTestFramework):
    ...
    # This test actually causes dogpud to (reasonably!) disconnect us, so do this last.
    ...
    # Test that dogpud requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for dogpud to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # dogpud will not send blocktxn responses for blocks whose height is
