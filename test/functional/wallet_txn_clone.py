...
class TxnMallTest(DogpuTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 DOGPUS:
        ...
        # 40 DOGPUS serialized is 00286bee00000000
        pos0 = 2*(4+1+36+1+4+1)
        ...
        # Check node0's total balance; should be same as before the clone, + 100 DOGPUS for 2 matured,
