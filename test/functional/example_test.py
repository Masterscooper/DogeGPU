...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the DogpuTestFramework
    pass

class ExampleTest(DogpuTestFramework):
    # Each functional test is a subclass of the DogpuTestFramework class.
    ...
    def custom_method(self):
        ...
        DogpuTestFramework class so other tests can use it."""
