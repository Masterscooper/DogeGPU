...
class BIP66Test(DogpuTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # dogpud is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and dogpud produces more specific reject
            # reasons.
