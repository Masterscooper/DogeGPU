...
from test_framework.wallet_util import bip39_dogpuch
...
MNEMONIC_2 = 'insolite hésiter gazelle ruche anxieux fluvial orange carton linéaire lueur ovation ennuyeux' #dogpuch
...
class Bip44Test(DogpuTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(len(bip39_dogpuch), 2048)
        ...
        for i in range(0, 12):
            ...
            assert_contains(word_list_2[i], bip39_dogpuch)
