...
class WalletTest(DogpuTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 DOGPUS from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 DOGPUS with subtract fee from amount
        ...
        # Sendmany 10 DOGPUS with subtract fee from amount
