...
class TxnMallTest(DogpuTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 DOGPUS:
        ...
        # First: use raw transaction API to send 1240 DOGPUS to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 DOGPUS coin each
        ...
        # Node0's balance should be starting balance, plus 50DOGPUS for another
        ...
        # Node0's total balance should be starting balance, plus 100DOGPUS for 
