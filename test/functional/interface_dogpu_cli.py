...
class TestDogpuCli(DogpuTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `dogpu-cli getinfo`")
        ...
        self.log.info("Compare responses from `dogpu-cli -getinfo` and the RPCs data is retrieved from.")
