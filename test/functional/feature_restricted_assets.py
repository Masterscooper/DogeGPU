...
from test_framework.test_framework import DogpuTestFramework
...
class RestrictedAssetsTest(DogpuTestFramework):
    ...
    def activate_restricted_assets(self):
        self.log.info("Generating DOGPUS and activating restricted assets...")
        n0 = self.nodes[0]
        n0.generate(432)
        self.sync_all()
        n1 = self.nodes[1]
    ...
    def issuerestrictedasset(self):
        ...
        assert_raises_rpc_error(None, "Invalid Dogpu address", n0.issuerestrictedasset, asset_name, qty, verifier, "garbageaddress")
    ...
    def issuerestrictedasset_full(self):
        ...
        # valid params
        assert_raises_rpc_error(None, "Invalid Dogpu address", n0.issuerestrictedasset, asset_name, qty, verifier, to_address, "garbagechangeaddress")
    ...
    def reissuerestrictedasset_full(self):
        ...
        assert_raises_rpc_error(None, "Invalid Dogpu address", n0.reissuerestrictedasset, asset_name, qty, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Dogpu address", n0.reissuerestrictedasset, asset_name, qty, to_address, change_verifier, verifier, "garbagechangeaddress")
    ...
    def issue_qualifier_asset_full(self):
        ...
        assert_raises_rpc_error(None, "Invalid Dogpu address", n0.issuequalifierasset, asset_name, qty, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Dogpu address", n0.issuequalifierasset, asset_name, qty, to_address, "gargabechangeaddress")
    ...
    def transferqualifier(self):
        ...
        assert_raises_rpc_error(None, "Invalid Dogpu address", n0.transferqualifier, asset_name, 1, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Dogpu address", n0.transferqualifier, asset_name, 1, n1_address, "garbagechangeaddress")
    ...
    def tagging(self):
        ...
        dogpus_change_address = n0.getnewaddress()
        asset_change_address = n0.getnewaddress()
        n0.addtagtoaddress(tag, dogpus_change_address)
        n0.addtagtoaddress(tag, asset_change_address)
        n0.generate(1)
        assert_raises_rpc_error(-8, "bad-txns-null-verifier-address-failed-verification", n0.transfer, asset_name, 100, address, "", 0, dogpus_change_address, asset_change_address)
        n0.removetagfromaddress(tag, dogpus_change_address)
        n0.removetagfromaddress(tag, asset_change_address)
        n0.generate(1)
        ##

        assert_raises_rpc_error(None, "Invalid Dogpu address", n0.addtagtoaddress, tag, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Dogpu change address", n0.addtagtoaddress, tag, address, "garbagechangeaddress")
        ...
        # special case: make sure transfer fails if the asset change address isn't verified (even if the dogpus change address is)
        dogpus_change_address = n0.getnewaddress()
        asset_change_address = n0.getnewaddress()
        assert_raises_rpc_error(-20, "bad-txns-null-verifier-address-failed-verification", n0.transfer, asset_name, 100, address, "", 0, dogpus_change_address, asset_change_address)
        n0.addtagtoaddress(tag, dogpus_change_address)
        n0.generate(1)
        assert_raises_rpc_error(-20, "bad-txns-null-verifier-address-failed-verification", n0.transfer, asset_name, 100, address, "", 0, dogpus_change_address, asset_change_address)
        n0.removetagfromaddress(tag, dogpus_change_address)
        ...
        assert_raises_rpc_error(None, "Invalid Dogpu address", n0.removetagfromaddress, tag, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Dogpu change address", n0.removetagfromaddress, tag, address, "garbagechangeaddress")
    ...
    def freezing(self):
        ...
        assert_raises_rpc_error(None, "Invalid Dogpu address", n0.freezeaddress, asset_name, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Dogpu change address", n0.freezeaddress, asset_name, address, "garbagechangeaddress")

        n0.freezeaddress(asset_name, address, dogpus_change_address)
        n0.generate(1)

        assert_raises_rpc_error(-32600, "freeze-address-when-already-frozen", n0.freezeaddress, asset_name, address, dogpus_change_address)
        ...
        assert_raises_rpc_error(None, "Invalid Dogpu address", n0.unfreezeaddress, asset_name, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Dogpu change address", n0.unfreezeaddress, asset_name, address, "garbagechangeaddress")

        n0.unfreezeaddress(asset_name, address, dogpus_change_address)
        n0.generate(1)

        assert_raises_rpc_error(-32600, "unfreeze-address-when-not-frozen", n0.unfreezeaddress, asset_name, address, dogpus_change_address)
    ...
    def global_freezing(self):
        ...
        assert_raises_rpc_error(None, "Invalid Dogpu change address", n0.freezerestrictedasset, asset_name, "garbagechangeaddress")

        n0.freezerestrictedasset(asset_name, dogpus_change_address)  # Can only freeze once!
        assert_raises_rpc_error(-26, "Freezing transaction already in mempool", n0.freezerestrictedasset, asset_name, dogpus_change_address)
        n0.generate(1)
        assert_raises_rpc_error(None, "global-freeze-when-already-frozen", n0.freezerestrictedasset, asset_name, dogpus_change_address)
        ...
        assert_raises_rpc_error(None, "Invalid Dogpu change address", n0.unfreezerestrictedasset, asset_name, "garbagechangeaddress")

        n0.unfreezerestrictedasset(asset_name, dogpus_change_address)  # Can only un-freeze once!
        assert_raises_rpc_error(-26, "Unfreezing transaction already in mempool", n0.unfreezerestrictedasset, asset_name, dogpus_change_address)
        n0.generate(1)
        assert_raises_rpc_error(None, "global-unfreeze-when-not-frozen", n0.unfreezerestrictedasset, asset_name, dogpus_change_address)
