...
class RewardsTest(DogpuTestFramework):
    ...
    # Basic functionality test - DOGPUS reward
    # - create the main owner address
    # - mine blocks to have enough DOGPUS for the reward payments, plus purchasing the asset
    ...
    # - distribute an DOGPUS reward amongst the shareholders
    # - verify that each one receives the expected amount of reward DOGPUS
    def basic_test_dogpus(self):
        self.log.info("Running basic DOGPUS reward test!")
        n0, n1, n2 = self.nodes[0], self.nodes[1], self.nodes[2]
        ...
        n0.distributereward(asset_name="STOCK1", snapshot_height=tgt_block_height, distribution_asset_name="DOGPUS",
        ...
        self.log.info("Verifying DOGPUS holdings after payout")
    ...
    # - create the main owner address
    # - mine blocks to have enough DOGPUS for the reward fees, plus purchasing the asset
    ...
    def payout_without_snapshot(self):
        ...
        assert_raises_rpc_error(-32600, "Snapshot request not found",
                                n0.distributereward, "STOCK3", tgt_block_height, "DOGPUS", 2000, owner_addr0)
    ...
    def payout_with_invalid_ownership_asset(self):
        ...
        assert_raises_rpc_error(-32600, "The asset hasn't been created: STOCK4",
                                n0.distributereward, "STOCK4", tgt_block_height, "DOGPUS", 2000, owner_addr0)
    ...
    def payout_before_minimum_height_is_reached(self):
        ...
        assert_raises_rpc_error(-32600,
                                ...
                                n0.distributereward, "STOCK6", tgt_block_height, "DOGPUS", 2000, owner_addr0)

    # Attempts a payout using a custom rewards height of 15, and they have low dogpus balance
    def payout_custom_height_set_with_low_funds(self):
        ...
        n1.distributereward("STOCK7", tgt_block_height, "DOGPUS", 2000, owner_addr0)

        n1.generate(2)
        self.sync_all()

        assert_equal(n1.getdistributestatus("STOCK7", tgt_block_height, "DOGPUS", 2000, owner_addr0)['Status'], 3)
    ...
    def basic_test_asset_uneven_distribution(self):
        ...
        n0.transferfromaddress(asset_name="STOCK8", from_address=dist_addr0, qty=300, to_address=shareholder_addr0,
                               message="", expire_time=0, dogpus_change_address="", asset_change_address=dist_addr0)
    ...
    def basic_test_asset_round_down_uneven_distribution_3(self):
        ...
        self.log.info("Distributing shares")
        n0.transferfromaddress(asset_name="STOCK12", from_address=dist_addr0, qty=9, to_address=shareholder_addr0, message="", expire_time=0, dogpus_change_address="", asset_change_address=dist_addr0)
        n0.transferfromaddress(asset_name="STOCK12", from_address=dist_addr0, qty=3, to_address=shareholder_addr1, message="", expire_time=0, dogpus_change_address="", asset_change_address=dist_addr0)
        n0.transferfromaddress(asset_name="STOCK12", from_address=dist_addr0, qty=2, to_address=shareholder_addr2, message="", expire_time=0, dogpus_change_address="", asset_change_address=dist_addr0)
        n0.transferfromaddress(asset_name="STOCK12", from_address=dist_addr0, qty=1, to_address=shareholder_addr3,  message="", expire_time=0, dogpus_change_address="", asset_change_address=dist_addr0)
    ...
    def test_dogpus_bulk(self):
        ...
        for address in address_list:
            n0.transferfromaddress(asset_name="BULK1", from_address=dist_addr0, qty=10, to_address=address, message="",
                                   expire_time=0, dogpus_change_address="", asset_change_address=dist_addr0)
            count += 1
            if count > 190:
                n0.generate(1)
                count = 0
