...
By default, dogpud will dump mempool on shutdown and
...
class MempoolPersistTest(DogpuTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give dogpud a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent dogpud from writing mempool.dat to disk. Verify that `savemempool` fails")
