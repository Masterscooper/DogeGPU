...
"""
    ...
    Dogpu should be started with the command line arguments:
        dogpud -testnet -daemon \
                -zmqpubhashblock=tcp://127.0.0.1:26068 \
                -zmqpubrawtx=tcp://127.0.0.1:26068 \
                -zmqpubhashtx=tcp://127.0.0.1:26068 \
                -zmqpubhashblock=tcp://127.0.0.1:26068
"""
...
print("Getting Dogegpu msgs")
socket.connect("tcp://localhost:26068")
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND DOGPUS issuance at " + str(pos))
				print("After DOGPUS: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND DOGPUS something at " + str(pos))
			start += pos+8
			print(astr)
