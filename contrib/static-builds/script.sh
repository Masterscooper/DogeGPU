...
find ${DISTNAME}/bin -type f -executable -exec ../dogegpu/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../dogegpu/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/dogegpu/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/dogegpu/depends/SDKs/MacOSX10.11.sdk.tar.gz
