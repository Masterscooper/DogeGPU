...
### IPFS Pinner
Loops through blocks and transactions and pins asset issuance meta-data and then monitors dogpud transactions for new ipfs metadata via zmq.
...
* Run dogpud or dogpu-qt with parameter to use zmq: ```-zmqpubrawtx=tcp://127.0.0.1:26068```
