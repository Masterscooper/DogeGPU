...
#Set this to your dogpu-cli program
cli = "dogpu-cli"

#mode = "-testnet"
mode = ""
rpc_port = 6068
#Set this information in your dogpu.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
	...
	for i in range(start_block,blockheight):
	    ...
	    for tx in txs:
	        ...
	        for vout in tx_detail.get('vout'):
	            if (vout.get('scriptPubKey').get('asm')[86:98] == "OP_DOGPUS_ASSET"):
	                print_debug("Found OP_DOGPUS_ASSET")
