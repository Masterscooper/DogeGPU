Contributing to Dogpu Core
============================

The Dogpu Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *GUI* for changes to dogpu-qt
  - *Mining* for changes to the mining code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST/ZMQ* for changes to the RPC, REST or ZMQ APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the dogpu unit tests or QA tests
...
The following applies to code changes to the Dogegpu project (and related
projects) and is not to be confused with overall Dogegpu
Network Protocol consensus changes.

Whether a pull request is merged into Dogegpu rests with the project merge
...
Patches that change Dogegpu consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dogegpu consensus, it must have been
...
The DogpuQT-SIG selects a release manager for each Dogegpu release.
