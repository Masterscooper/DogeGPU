...
We’re all in this together. There are new capabilities included in the latest Phoenix version (3.2+) of DogeGPU that open up new business opportunities.  Join in and build something.  This is not an exhaustive list, but just a starting point to fire the imagination.  
...
* Run a contest: RVN prize for best idea for new DogeGPU based Business
...
* Back-end API platform for DogeGPU
...
* #KYC tagger - store info and tag DogeGPU addresses
* #ACCREDITED - verify accredited status and tag DogeGPU addresses
 
### Technical Consultant
* Help companies apply DogeGPU capabilities to real-world problems
* Security Token Issuance Platform
